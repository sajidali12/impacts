        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    @if(count($topPerformingServices) > 0)
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach($topPerformingServices as $service)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                @if(isset($service['pricing']) && $service['pricing'])
                                                    £{{ number_format($service['pricing'], 2) }}
                                                    @if(isset($service['pricing_type']))
                                                        <span class="text-gray-500">/ {{ $service['pricing_type'] }}</span>
                                                    @endif
                                                @else
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Add some services to see performance analytics.</p>
                            <div class="mt-6">
            ...
            <div class="mt-8 bg-purple-50 border border-purple-200 rounded-lg p-6">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-purple-800">Analytics Tips</h3>
                        <div class="mt-2 text-sm text-purple-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Higher conversion rates indicate better service presentation and targeting</li>
                                <li>Monitor weekly trends to identify seasonal patterns in service demand</li>
                                <li>Services with high views but low conversions may need better descriptions or pricing adjustments</li>
                                <li>Use analytics data to optimize your service offerings and marketing strategy</li>
                                <li>Consider specializing in service types that consistently generate more leads</li>
                            </ul>
                        </div>
                    </div>
                </div>
