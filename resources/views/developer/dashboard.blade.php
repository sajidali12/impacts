        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
                    ...
                    <p class="mt-1 text-blue-100">Manage your property listings and track your leads.</p>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $stats['active_properties'] }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="rounded-md bg-yellow-50 p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('developer.invoices') }}" class="text-sm font-medium text-yellow-800 hover:text-yellow-900">
                                            View Invoices →
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="{{ route('developer.properties.index') }}" class="text-sm text-indigo-600 hover:text-indigo-500">View all →</a>
                        </div>
                                ...
                                @foreach($recentProperties as $property)
                                    <div class="flex items-center justify-between border-b pb-3">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm font-semibold text-indigo-600">{{ $property->formatted_price }}</p>
                                        </div>
                                        <div class="text-right text-xs text-gray-500">
                                            <div>{{ $property->view_count }} views</div>
                                            <div>{{ $property->lead_count }} leads</div>
                                            <div class="mt-1">
                        ...
                        @else
                            <div class="text-center py-6">
                                ...
                                <div class="mt-6">
                                    <a href="{{ route('developer.properties.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                                        Add Property
                                    </a>
                                </div>
                            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <a href="{{ route('developer.analytics') }}" class="text-sm text-indigo-600 hover:text-indigo-500">View analytics →</a>
                        </div>
                        ...
                        @else
                            <div class="text-center py-6">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Leads will appear here when people contact you about your properties.</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            <a href="{{ route('developer.properties.create') }}" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                            ...
                            <a href="{{ route('developer.properties.index') }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/>
                                </svg>
                                Manage Properties
                            ...
                            <a href="{{ route('developer.analytics') }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <a href="{{ route('developer.invoices') }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
